<h2><a href="https://leetcode.com/problems/determine-if-string-halves-are-alike/?envType=problem-list-v2&envId=counting">1823. Determine if String Halves Are Alike</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code> of even length. Split this string into two halves of equal lengths, and let <code>a</code> be the first half and <code>b</code> be the second half.</p>
