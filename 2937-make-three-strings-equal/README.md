<h2><a href="https://leetcode.com/problems/make-three-strings-equal/description/?envType=problem-list-v2&envId=string">3207. Make Three Strings Equal</a></h2><h3>Easy</h3><hr><p>You are given three strings: <code>s1</code>, <code>s2</code>, and <code>s3</code>. In one operation you can choose one of these strings and delete its <strong>rightmost</strong> character. Note that you <strong>cannot</strong> completely empty a string.</p>
